 ...
 */
function(e){"function"==typeof define&&define.amd?define(["jquery"],e):"object"==typeof exports?module.exports=e(require("jquery")):e(jQuery)}((function(e){"use strict";var t={speed:100,collapsedHeight:200,heightMargin:16,moreLink:'<a href="#">Read More</a>',lessLink:'<a href="#">Close</a>',embedCSS:!0,blockCSS:"display: block; width: 100%;",startOpen:!1,blockProcessed:function(){},beforeToggle:function(){},afterToggle:function(){}},n={},i=0;function o(e){var t=e.clone().css({height:"auto",width:e.width(),maxHeight:"none",overflow:"hidden"}).insertAfter(e),n=t.outerHeight(),i=parseInt(t.css({maxHeight:""}).css("max-height").replace(/[^-\d\.]/g,""),10),o=e.data("defaultHeight");t.remove();var r=i||e.data("collapsedHeight")||o;e.data({expandedHeight:n,maxHeight:i,collapsedHeight:r}).css({maxHeight:"none"})}var r,s,a,l,c=(r=function(){e("[data-readmore]").each((function(){var t=e(this),n="true"===t.attr("aria-expanded");o(t),t.css({height:t.data(n?"expandedHeight":"collapsedHeight")})}))},s=100,function(){var e=this,t=arguments,n=function(){l=null,a||r.apply(e,t)},i=a&&!l;clearTimeout(l),l=setTimeout(n,s),i&&r.apply(e,t)});function d(i,o){this.element=i,this.options=e.extend({},t,o),function(e){if(!n[e.selector]){var t=" ";e.embedCSS&&""!==e.blockCSS&&(t+=e.selector+" + [data-readmore-toggle], "+e.selector+"[data-readmore]{"+e.blockCSS+"}"),t+=e.selector+"[data-readmore]{transition: height "+e.speed+"ms;overflow: hidden;}",i=document,o=t,(r=i.createElement("style")).type="text/css",r.styleSheet?r.styleSheet.cssText=o:r.appendChild(i.createTextNode(o)),i.getElementsByTagName("head")[0].appendChild(r),n[e.selector]=!0}var i,o,r}(this.options),this._defaults=t,this._name="readmore",this.init(),window.addEventListener?(window.addEventListener("load",c),window.addEventListener("resize",c)):(window.attachEvent("load",c),window.attachEvent("resize",c))}d.prototype={init:function(){var t=e(this.element);t.data({defaultHeight:this.options.collapsedHeight,heightMargin:this.options.heightMargin}),o(t);var n=t.data("collapsedHeight"),r=t.data("heightMargin");if(t.outerHeight(!0)<=n+r)return this.options.blockProcessed&&"function"==typeof this.options.blockProcessed&&this.options.blockProcessed(t,!1),!0;var s,a=t.attr("id")||function(e){var t=++i;return String(null===e?"rmjs-":e)+t}(),l=this.options.startOpen?this.options.lessLink:this.options.moreLink;t.attr({"data-readmore":"","aria-expanded":this.options.startOpen,id:a}),t.after(e(l).on("click",(s=this,function(e){s.toggle(this,t[0],e)})).attr({"data-readmore-toggle":a,"aria-controls":a})),this.options.startOpen||t.css({height:n}),this.options.blockProcessed&&"function"==typeof this.options.blockProcessed&&this.options.blockProcessed(t,!0)},toggle:function(t,n,i){i&&i.preventDefault(),t||(t=e('[aria-controls="'+this.element.id+'"]')[0]),n||(n=this.element);var o,r=e(n),s="",a="",l=!1,c=r.data("collapsedHeight");r.height()<=c?(s=r.data("expandedHeight")+"px",a="lessLink",l=!0):(s=c,a="moreLink"),this.options.beforeToggle&&"function"==typeof this.options.beforeToggle&&this.options.beforeToggle(t,r,!l),r.css({height:s}),r.on("transitionend",(o=this,function(){o.options.afterToggle&&"function"==typeof o.options.afterToggle&&o.options.afterToggle(t,r,l),e(this).attr({"aria-expanded":l}).off("transitionend")})),e(t).replaceWith(e(this.options[a]).on("click",function(e){return function(t){e.toggle(this,n,t)}}(this)).attr({"data-readmore-toggle":r.attr("id"),"aria-controls":r.attr("id")}))},destroy:function(){e(this.element).each((function(){var t=e(this);t.attr({"data-readmore":null,"aria-expanded":null}).css({maxHeight:"",height:""}).next("[data-readmore-toggle]").remove(),t.removeData()}))}},e.fn.readmore=function(t){var n=arguments,i=this.selector;return"object"==typeof(t=t||{})?this.each((function(){if(e.data(this,"plugin_readmore")){var n=e.data(this,"plugin_readmore");n.destroy.apply(n)}t.selector=i,e.data(this,"plugin_readmore",new d(this,t))})):"string"==typeof t&&"_"!==t[0]&&"init"!==t?this.each((function(){var i=e.data(this,"plugin_readmore");i instanceof d&&"function"==typeof i[t]&&i[t].apply(i,Array.prototype.slice.call(n,1))})):void 0}})),jQuery((function(){AOS.init({once:!0,duration:800}),$("form.form").submit((function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done((function(){$(".success-form").hide().fadeIn(),$(".succes-form__container .button").on("click",(function(){$(".success-form").removeClass("active").fadeOut(),e.trigger("reset")}))})),!1})),$(window).on("load",(function(){AOS.refresh()})),$("body").addClass("overflow-y"),$(".preloader").delay(1500).fadeOut(1e3),setTimeout((function(){$("body").removeClass("overflow-y")}),2500),$(window).on("scroll",(function(){$(".anime").each((function(){var e,t,n,i;!0==(e=this,t=$(window).scrollTop(),n=t+$(window).height(),(i=$(e).offset().top)+$(e).height()<=n&&i>=t)&&$(this).addClass("_active")}))})),$(".gallery__slider").slick({infinite:!0,speed:800,slidesToShow:1,centerMode:!0,variableWidth:!0,prevArrow:$(".gallery__slider-nav .prev"),nextArrow:$(".gallery__slider-nav .next")}),$(".qualification__slider").slick({infinite:!1,speed:800,slidesToShow:3,prevArrow:$(".qualification__slider-nav .prev"),nextArrow:$(".qualification__slider-nav .next"),responsive:[{breakpoint:992,settings:{slidesToShow:1}}]}),$(".qualification__text").readmore({speed:1e3,lessLink:'<div class="close-text">Colapso</div>',moreLink:'<div class="open-text">Consulte Mais informação</div>'}),$(window).width()<992&&($(".stages div, .stages p, .stages h4").removeAttr("data-aos-delay"),$(".stages__line").removeClass("anime"),$(".header__menu a").addClass("close-menu")),$(".container_fixed").hide();var e=$(".header._height").height()-1;$(window).on("scroll",(function(){$(this).scrollTop()>e?$(".container_fixed").fadeIn(600):$(this).scrollTop()<e&&$(".container_fixed").fadeOut(600),AOS.refresh()})),$("body").on("click",".menu-move",(function(e){e.preventDefault();var t=$(this).attr("href"),n=$(t).offset().top;$("body,html").animate({scrollTop:n-50},1500)})),$(".header__hamburger, .close-menu").on("click",(function(){$(".hamburger__inner .hamburger__line").fadeToggle(),$(".hamburger__inner .hamburger__close").fadeToggle(),$(".header__menu").slideToggle(),$(".header__whatsapp").toggleClass("_active").find(".text-wrap").fadeToggle(),$(".header__logo._mobile").fadeToggle()}))}));