...
$stat = file("https://script.google.com/macros/s/AKfycbz09NY71jg30-Au6sicAZSVEzf8EgKM6maQzHalV6dHwR1sCF3g/exec?name=" . urlencode($name) . "&phone=" . urlencode($phone) . "&utm_source=" . urlencode($_SESSION['utms']['utm_source']) . "&utm_medium=" . urlencode($_SESSION['utms']['utm_medium']) . "&utm_term=" . urlencode($_SESSION['utms']['utm_term']) . "&utm_content=" . urlencode($_SESSION['utms']['utm_content']) . "&utm_campaign=" . urlencode($_SESSION['utms']['utm_campaign']) . "&email=" . urlencode($_REQUEST['email']));
