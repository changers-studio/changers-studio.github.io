		...
		var t,
						...
						e(o).each(function () {
							...
							if (!o.data(a)) {
								...
								l && (i.axis = l),
									...
									e('#mCSB_' + n.idx + '_container img:not(.' + d[2] + ')').addClass(
										d[2]
									),
			...
			I = function () {
				...
				m
					...
					e(document)
						...
						.add(p)
						.bind(
							'mouseup.' + u + ' touchend.' + u + ' pointerup.' + u + ' MSPointerUp.' + u,
							function () {
			...
			D = function () {
				...
				function s(e, t, o, a, n, i) {
					e &&
						G(y, e.toString(), { dur: t, scrollEasing: o, dir: a, overwrite: n, drag: i })
				}
				var d,
					u,
					f,
			...
			X = function (t, o) {
				if (null != t && 'undefined' != typeof t) {
					...
					o || (o = 'x' === r.axis ? 'x' : 'y')
					var d =
							'x' === o ? l.outerWidth(!1) - s.width() : l.outerHeight(!1) - s.height(),
					...
					switch (n) {
						...
						default:
							...
							return (
								t +
								o *
									(0.499999999999997 * r * i + -2.5 * i * i + 5.5 * r + -6.5 * i + 4 * e)
							)
					}
				}
